...
begin
  ...
  Application.MessageBox('Hoàn thành', 'Cảnh báo!', MB_ICONQUESTION);
  Close;
end;
...
begin
  case RadioGroup1.ItemIndex of
    0: begin
        ...
        RzLabel.Caption := 'Ảnh và tọa độ:';
      end;
    1: begin
        EditFileDir.Enabled := True;
        RadioGroup3.Enabled := True;
        GroupBox4.Enabled := False;
        RzLabel.Caption := 'Hình ảnh:';
      end;
    2: begin
        EditFileDir.Enabled := True;
        GroupBox4.Enabled := True;
...
var
  Directory: string;
begin
  if SelectDirectory('Lụa chọn đường dẫn', '', Directory, frmInPutManyDlg.Handle) then begin
