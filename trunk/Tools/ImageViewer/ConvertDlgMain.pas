...
begin
  with OpenDialog do begin
    case RadioGroup.ItemIndex of
      0, 2: Filter := 'Dữ liệu dạng WIL (*.Wil)|*.Wil';
      1, 4: Filter := 'Dữ liệu dạng WIS (*.Wis)|*.Wis';
      3, 5: Filter := 'Dữ liệu dạng Data (*.Data)|*.Data';
    end;
...
begin
  with SaveDialog do begin
    case RadioGroup.ItemIndex of
      1, 3: Filter := 'Dữ liệu dạng WIL (*.Wil)|*.Wil';
      0, 5: Filter := 'Dữ liệu dạng WIS (*.Wis)|*.Wis';
      2, 4: Filter := 'Dữ liệu dạng Data (*.Data)|*.Data';
    end;
...
begin
  ...
  try
    ...
    if FileExists(sFileName) then begin
      ...
      if NewGameImages.CreateFile(BitCount) then begin
        ...
        for I := 0 to GameImages.ImageCount - 1 do begin
          ...
          Caption := Format('Hoàn thành »»(%d/%d)', [I + 1, GameImages.ImageCount]);
    ...
    Application.MessageBox('Hoàn thành chuyển đổi dữ liệu', 'Cảnh báo!', MB_ICONQUESTION);
  finally
    g_boWalking := False;
