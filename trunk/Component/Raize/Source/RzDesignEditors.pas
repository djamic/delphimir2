...
type
  ...
  TRzFrameStyleProperty = class( TEnumProperty, ICustomPropertyDrawing, ICustomPropertyListDrawing
                                 {$IFDEF VCL90_OR_HIGHER}, ICustomPropertyDrawing80 {$ENDIF} )
  private
  ...
  TRzAlignProperty = class( TEnumProperty, ICustomPropertyDrawing
                            {$IFNDEF VCL90_OR_HIGHER}, ICustomPropertyListDrawing {$ENDIF}
                            {$IFDEF VCL90_OR_HIGHER}, ICustomPropertyDrawing80, IProperty80 {$ENDIF} )
  private
    {$IFDEF VCL90_OR_HIGHER}
...
procedure TRzAlignProperty.ListDrawValue( const Value: string; ACanvas: TCanvas;
                                          const ARect: TRect; ASelected: Boolean );
var
  ValueRect: TRect;
begin
