...
begin
  ...
  // If code gets compiled with Delphi 2007 or higher, then utilize 
  // Application.MainFormOnTaskBar property directly
  ...
  begin
    MainFormStyle := GetWindowLong( Application.MainForm.Handle, GWL_EXSTYLE );
    Result := MainFormStyle and WS_EX_APPWINDOW = WS_EX_APPWINDOW;
  end
  else
    Result := False;
