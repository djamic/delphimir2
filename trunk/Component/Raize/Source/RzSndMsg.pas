  ...
  try
    ...
    begin
      ...
      begin
        ...
        begin
          StrPCopy( RecipName, AnsiString( FToRecipients[ I ] ) );
          RecipClass := mapi_TO;
        end
        else if I < FToRecipients.Count + FCcRecipients.Count then
        begin
          StrPCopy( RecipName, AnsiString( FCcRecipients[ I - FToRecipients.Count ] ) );
          RecipClass := mapi_CC;
        end
        else
        begin
          StrPCopy( RecipName, AnsiString( FBccRecipients[ I - FToRecipients.Count - FCcRecipients.Count ] ) );
          RecipClass := mapi_BCC;
        end;
        ...
        begin
          ...
          TRecipArray( Recips^ )[ I ].lpszAddress := StrNew( StrPCopy( TempStz, AnsiString( 'SMTP:' + RecipName ) ) );
        end;
      end;
      Msg.lpRecips := Recips;
    end;
    ...
    begin
      ...
      begin
        ...
        TFileArray(Files^)[ I ].lpszPathName := StrNew( StrPCopy( TempStz, AnsiString( FullPath ) ) );
