...
begin
  ...
  begin
    ...
    TextRct := Rect;
    H := DrawString( Canvas, Caption, TextRct,
    ...
    DrawString( Canvas, Caption, Rect, dt_ExpandTabs or dt_VCenter or
                                       DrawTextWordWrap[ WordWrap ] or
                                       DrawTextAlignments[ Alignment ] );
  end;
...
var
  R, SaveRect: TRect;
  StartColor, StopColor, FC, C: TColor;
  FCA: Integer;
    ...
    begin
      if FSimpleCaption <> '' then
        ThemeServices.DrawText( Canvas.Handle, ElementDetails, WideString( FSimpleCaption ), ClientRect,
                                dt_SingleLine or dt_NoPrefix or dt_VCenter, 0 );
    end;
