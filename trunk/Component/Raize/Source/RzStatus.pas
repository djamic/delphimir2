...
// The following structures are defined in RAD Studio 2009 and later
...
type
  TGlobalMemoryStatusExFunc = function( var lpBuffer: TMemoryStatusEx ): BOOL; stdcall;
var
  F: TGlobalMemoryStatusExFunc;
begin
  F := TGlobalMemoryStatusExFunc( GetProcAddress( GetModuleHandle( kernel32 ), 'GlobalMemoryStatusEx' ) );
