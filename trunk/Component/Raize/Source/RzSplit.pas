...
// The TControl.ClientToParent implementation in Delphi 7 and earlier does not
// work correctly, so we use the same implementation from Delphi 2005 and later.
