...
begin
  ...
  case g_nWorkStatus of
    ...
    DB_LOADHERORCD: begin //¶ÁÈ¡Ó¢ÐÛÊý¾Ý
        LabelWorkStatus.Font.Color := clGreen;
        LabelWorkStatus.Caption := 'Load Hero';
      end;
    DB_NEWHERORCD: begin //ÐÂ½¨Ó¢ÐÛ
        LabelWorkStatus.Font.Color := clGreen;
        LabelWorkStatus.Caption := 'New Hero';
      end;
    DB_DELHERORCD: begin //É¾³ýÓ¢ÐÛ
        LabelWorkStatus.Font.Color := clGreen;
        LabelWorkStatus.Caption := 'Del Hero';
      end;
    DB_SAVEHERORCD: begin //±£´æÓ¢ÐÛÊý¾Ý
        LabelWorkStatus.Font.Color := clGreen;
        LabelWorkStatus.Caption := 'Save Hero';
      end;
    DB_LOADRANKING: begin //ÅÅÐÐ°ñ
        LabelWorkStatus.Font.Color := clGreen;
...
{$IFEND}
  ...
  SelectSocket.Active := False;
  ServerSocket.Active := False;
  MainOutMessage('Đã ngừng server...');
end;
