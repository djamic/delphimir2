...
function StrToTimeEx( const S: string; var DateTime: TDateTime ): Boolean;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if K > 999 then
            C := 'Y'
          else if ( K > 12 ) and ( C <> 'Y' ) and not FoundDay then
          begin
            C := 'D';
            FoundDay := True;
          end;
...
begin
  ...
  ControlStyle := ControlStyle -
                  [ csAcceptsControls, csNoStdEvents, csSetCaption,
                    csDoubleClicks ] +
                  [ csReflector ];
