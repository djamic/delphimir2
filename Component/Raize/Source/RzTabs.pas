...
begin
  ...
  DrawTabButtonBackground( Canvas, R, FTabControl, FDown, FMouseOverButton,
                           LighterColor( FFrameColor, 30 ) );
...
begin
  ...
  if FMouseOverButton then
  begin
    DrawTabButtonBackground( Canvas, R, FTabControl, FDown, True, FFrameColor );
    DrawCloseX( Canvas, R, FTabControl.TabColors.HighlightBar, FDown, True );
  end
  else
  begin
    DrawCloseX( Canvas, R, FFrameColor, FDown, True );
  end;
